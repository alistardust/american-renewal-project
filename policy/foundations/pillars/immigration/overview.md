...
The immigration pillar contains **222 policy rules** organized into **24 family codes**, each addressing a specific domain of immigration law, administration, and enforcement. This structure provides comprehensive coverage while maintaining clarity and navigability.

### Family Code Structure

**Rights, Process, and Protections (49 rules)**
- **RGT** (Rights) — 9 rules: Core human rights principles, anti-cruelty prohibitions, equal access guarantees
- **DUE** (Due Process) — 11 rules: Notice, interpretation, records access, counsel, reviewability, habeas corpus
- **DET** (Detention) — 12 rules: Strict limits, indefinite detention ban, alternatives, private detention prohibition
- **FAM** (Family) — 4 rules: Family separation prohibitions, unity prioritization, child protections
- **CRT** (Courts) — 4 rules: Independent adjudication, fair procedures, competent training
- **DAT** (Data Privacy) — 4 rules: Surveillance limits, data-sharing restrictions, correction rights
- **CON** (Contractors) — 16 rules: Accountability standards, core function prohibitions, oversight requirements

**Status, Pathways, and Citizenship (22 rules)**
- **STS** (Status) — 12 rules: Lawful pathway expansion, regularization, DACA-type protections, backlog reduction
- **CIT** (Citizenship) — 10 rules: Naturalization access, birthright citizenship protection, fee reform, procedural clarity

**Humanitarian Protection (23 rules)**
- **ASY** (Asylum) — 13 rules: Fair screening, credible fear protection, trauma-informed procedures, anti-detention pressure
- **REF** (Refugees) — 10 rules: Resettlement systems, integration support, international coordination

**Labor and Exploitation (15 rules)**
- **LAB** (Labor) — 10 rules: Worker protection regardless of status, anti-retaliation safeguards, visa portability, anti-indenture rules
- **TRF** (Trafficking) — 5 rules: Victim protection, T-visa access, safe harbor from prosecution, support services

**Enforcement and Removal (42 rules)**
- **ENF** (Enforcement) — 5 rules: ICE abolition and replacement, strict statutory limits, rights protections, structural separation
- **REM** (Removal) — 16 rules: Deportation destination limits, safety assessment, reviewability, anti-refoulement
- **BRD** (Border) — 11 rules: Humane governance, force limits, facility standards, emergency power constraints, civilian accountability
- **SRV** (Services) — 12 rules: Local sanctuary protections, access to emergency care, education guarantees, non-cooperation authority

**Administration and Transparency (30 rules)**
- **ADM** (Administration) — 8 rules: Backlog reduction, procedural simplification, clear guidance, error correction
- **OVR** (Oversight) — 4 rules: Independent inspection, mandatory reporting, abuse investigation, pattern-based remediation
- **ACC** (Access) — 6 rules: Emergency care and education access, multilingual navigation, anti-retaliation protections
- **SYS** (System) — 4 rules: Comprehensive reform, fragmentation elimination, rights-centered design
- **DOC** (Documentation) — 2 rules: Identity marker updates, cross-agency consistency
- **INT** (Integration) — 4 rules: Language support, community navigation, long-term stability services
- **VIS** (Visas) — 30 rules: Comprehensive visa system reform, per-country limit elimination, processing improvements, fee reduction
...
### 1. Due Process and Fair Procedures
...
### 2. Detention Reform and Private Detention Prohibition
Immigration detention is strictly limited and cannot be used as default administrative convenience or deterrence. Indefinite detention is prohibited. Private immigration detention facilities are completely prohibited — custody cannot be outsourced to profit-driven contractors. Alternatives to detention are preferred where appearance and safety can be maintained. Any detention must meet strong standards for healthcare, safety, dignity, and communication. Detention requires prompt individualized review and periodic re-review.

### 3. ICE Abolition and Enforcement Restructuring
Immigration and Customs Enforcement in its current form must be abolished and replaced with narrower, rights-constrained, transparently governed structures that cannot reproduce current abuse patterns. Replacement enforcement must operate under strict statutory limits, independent oversight, public reporting, and enforceable civil-rights protections. Enforcement agencies cannot use broad discretionary power, fragmented secrecy, or deterrence-through-cruelty practices. Enforcement functions are structurally separated from humanitarian processing and adjudication.

### 4. Family Unity and Anti-Separation Protections
Family separation in immigration enforcement is prohibited except under narrowly defined, reviewable conditions involving immediate safety necessity. Immigration systems prioritize family unity and provide procedures for reunification and coordinated case processing. Children receive heightened protections including access to care, education, guardianship support, and developmentally appropriate process. Families cannot be coerced into waiver or removal decisions through detention threats, separation threats, or deprivation of care.

### 5. Asylum and Humanitarian Protection
People seeking asylum or humanitarian protection have meaningful access to fair screening, full adjudication, and protection from summary rejection where credible claims exist. Asylum systems cannot rely on impossible deadlines, inaccessible documentation demands, or unsafe return assumptions. Credibility determinations must be made by accountable humans under fair standards — not AI or pseudoscientific tools. People with credible fear cannot be removed before meaningful review and appeal opportunities. Systems account for trauma, language barriers, family disruption, and documentation limits without treating them as proof against the applicant. Detention cannot be used to pressure abandonment of asylum claims.

### 6. Refugee Resettlement
The United States maintains a robust refugee resettlement system grounded in humanitarian responsibility, due process, and long-term integration support. Refugees receive comprehensive services including language training, employment assistance, healthcare access, and community navigation. Resettlement caps should be set based on humanitarian need and capacity, not political convenience. Systems coordinate with state and local institutions to support long-term integration.

### 7. Status Pathways and Regularization
Immigration policy provides realistic lawful pathways to status for long-term residents with community ties rather than preserving permanent precarity. Status-adjustment systems are clear, affordable, navigable, and not dependent on excessive bureaucracy or arbitrary delay. People brought to the country as children or raised substantially in the United States have strong and stable pathways to lawful status and citizenship. Immigration law reduces long-term undocumented limbo by expanding workable legal pathways and resolving backlogs. Status eligibility accounts for family unity, labor contribution, long-term residence, and humanitarian considerations.

### 8. Citizenship and Naturalization
Pathways to citizenship are clear, affordable, and realistically attainable for people who meet established criteria. Citizenship systems are not structured to preserve arbitrary exclusion through excessive fees, delay, or procedural complexity. Birthright citizenship remains explicit and protected against erosion or reinterpretation. Long-term lawful residents have fair and stable pathways to full civic participation including citizenship. Naturalization systems include accessible language support, accommodations, and process guidance. Fees include waivers or public support mechanisms so low-income applicants are not excluded.

### 9. Labor Protections and Anti-Exploitation
Immigration status cannot be used by employers to suppress wages, retaliate against workers, or evade labor law. All workers regardless of immigration status are protected by labor safety, wage, and anti-exploitation laws. Reporting labor abuse, wage theft, trafficking, or unsafe working conditions cannot expose workers to retaliatory immigration enforcement. Visa and work authorization systems are designed to reduce employer domination and dependency that create coercive working conditions. Workers on employer-tied visas have meaningful portability so they can leave abusive, exploitative, or unsafe employers without losing lawful status immediately. Pathways tied to labor participation do not function as systems of indenture or employer-controlled status captivity.

### 10. Visa System Overhaul
The overall system for obtaining visas, green cards, permanent residence, and lawful status must be comprehensively overhauled to reduce delay, arbitrariness, complexity, and structural unfairness. Visa and permanent-residence systems are simplified and standardized to reduce excessive bureaucracy, backlog, and legal precarity. Application fees and procedural burdens are not set at levels that functionally exclude ordinary applicants. Backlogs in family-based, employment-based, and humanitarian immigration pathways are reduced through structural reform. Per-country caps are eliminated or substantially reformed to reduce decades-long backlogs. Lawful-status systems include clearer timelines, status transparency, and predictable adjudication standards.

### 11. Border Governance and Enforcement Limits
Border governance is lawful, humane, and accountable — it cannot rely on indiscriminate force or degrading treatment. Border enforcement powers are clearly limited by constitutional rights, civil liberties, and human-rights standards. Use of force is strictly constrained, reviewable, and subject to independent oversight and disclosure. Border processing systems are designed for order and speed without sacrificing due process, humanitarian protection, or access to review. Border enforcement is not militarized in ways that normalize permanent emergency powers or undermine civilian accountability. Border officials are subject to body-camera, record-retention, and evidence-preservation rules. Independent review mechanisms investigate deaths, abuse, force incidents, and rights violations. Border enforcement cannot use deprivation of food, water, medical care, shelter, hygiene, or communication access as tools of deterrence or compliance. Border processing facilities meet humane standards for healthcare, sanitation, temperature, child safety, disability access, and family integrity.

### 12. Sanctuary and Local Protections
State and local governments are not required to enforce federal immigration law or to use local resources for immigration enforcement purposes. Local jurisdictions can establish sanctuary policies that prioritize community trust, public safety, and access to services over immigration enforcement cooperation. Basic access to reporting crime, seeking emergency help, attending school, or seeking healthcare does not trigger retaliatory immigration enforcement. State and local institutions cannot use ordinary public-service access points as covert immigration-enforcement traps.

### 13. Administrative Fairness and Backlog Reduction
Immigration systems are funded and staffed to reduce backlogs and delays that create injustice through prolonged uncertainty. Administrative simplification reduces complexity, duplication, and document burdens that make legal compliance inaccessible. People have accessible status updates, document access, and case information without relying on opaque or hostile bureaucratic systems. Immigration forms, notices, deadlines, and legal standards are written in clearer language and supported by navigable public guidance. Backlog reduction efforts do not sacrifice accuracy, due process, or individualized review. Immigration agencies cannot use contradictory document standards, shifting requirements, or opaque procedural changes as de facto denial mechanisms. Where agency error, delay, or lost records materially harms an applicant, the system provides corrective remedies rather than placing full burden on the applicant.

### 14. Data Privacy and Surveillance Limits
Immigration systems cannot use broad data surveillance or commercially acquired data to bypass due process or create shadow enforcement profiles. Data-sharing between immigration systems and other government systems is tightly limited, transparent, and legally justified. Immigration data is treated as highly sensitive and cannot be used for unrelated profiling, commercial use, or political targeting. Record systems include correction mechanisms so people can challenge inaccurate data that affects status, detention, or removal risk.

### 15. Contractor Accountability and Core Function Prohibitions
Immigration enforcement, detention, adjudication, and core administrative functions cannot be delegated to private contractors — they must be performed by publicly accountable government entities. Core immigration functions include detention custody, transportation, enforcement, decision-making, adjudication, case management, and access to legal or custodial records. Limited use of contractors may be permitted for non-core support services such as facility maintenance, translation, technical infrastructure, or food services where those functions do not involve custody authority, decision-making, or rights-impacting control. Contractors cannot exercise authority over individuals including detention control, transport authority, enforcement discretion, or access to sensitive legal decision-making processes. No compensation structure may reward detention volume, enforcement activity, removals, denial rates, or any metric tied to deprivation of liberty or rights. All permitted contractors are subject to full public-law accountability including transparency requirements, records access, audit authority, and legal liability equivalent to government actors. Individuals harmed by contractor actions have full legal recourse against both the contractor and the responsible government entity.

### 16. Oversight, Transparency, and Anti-Abuse Enforcement
Immigration agencies and detention systems are subject to strong independent oversight with access to facilities, records, and decision patterns. Immigration systems publish standardized data on detention, removals, processing times, family separation outcomes, legal representation access, and rights complaints. Patterns of abuse, rights violations, discriminatory enforcement, or unlawful detention trigger mandatory corrective action and review. Immigration officials and agencies cannot evade accountability through secrecy, exceptional process, or fragmented jurisdictional responsibility.

### 17. Trafficking Victim Protections
Immigration systems provide robust protections for trafficking victims including safe harbor from prosecution for offenses committed under coercion, access to T-visas and protection status, trauma-informed services, and protection from retaliation. Trafficking victims receive comprehensive support services including housing, healthcare, legal representation, and long-term stability resources. Systems are designed to reduce barriers that prevent trafficking victims from seeking help or accessing protection.

### 18. Removal Limits and Safety Requirements
People may not be deported to countries that are not their country of origin, nationality, lawful residency, or another country where lawful admission and safety are clearly established. Removal cannot be carried out to any country where the person faces serious risk of persecution, torture, disappearance, trafficking, or other severe rights violations. Third-country removals require strict legal standards, meaningful review, and proof of lawful acceptance and safety. Removal decisions in protection cases include individualized safety assessment and cannot rely on generalized country assumptions alone.

### 19. Access to Services and Basic Rights
Immigration status may affect specific program eligibility but cannot be used to deny emergency care, basic education, or other core rights-protective systems guaranteed under law. Children within United States jurisdiction have meaningful access to education and basic developmental supports regardless of immigration status. Local access to healthcare, schooling, identification support, and legal process is designed so immigrants are not forced into invisibility or exploitation by bureaucratic exclusion. Public-service systems provide clear multilingual navigation so immigrants can understand rights, obligations, and available resources.

### 20. Documentation and Identity Rights
Immigration and travel document systems respect updated legal identity information and do not impose contradictory marker rules across agencies. Removal of sex and gender markers from passports and identity documents is implemented in ways that do not create new barriers to travel, status processing, or safety. People have an explicit right to update sex and gender markers on birth records, passports, identification documents, and other legal records without abusive barriers. No one is required to undergo sterilization, surgery, or other irreversible medical procedures to update legal identity records.
...
These choices have produced a system that is simultaneously cruel, ineffective, expensive, and destabilizing. Immigration enforcement consumes tens of billions of dollars annually while creating massive human suffering, economic inefficiency, and social division. Meanwhile, the actual challenges of border management, humanitarian protection, legal immigration processing, and integration support remain chronically underfunded and neglected.

### Legal Pathways and Visa System Dysfunction
...
### Asylum Reform and Humanitarian Protection
...
### Due Process Failures and Access to Justice
...
### Labor Exploitation and Immigration Status as a Weapon
...
### Border Policy, Militarization, and Emergency Powers
...
### Oversight, Accountability, and Transparency Failures
...
### Contractor Accountability and Core Function Protections
...
Private detention contractors are paid per person per day, creating direct financial incentives to maximize detention populations and duration. Some contracts include bed quotas or guaranteed minimum payments regardless of detention levels. Companies lobby for policies that expand detention and removal. And companies resist reforms that would reduce confinement.
...
### Data Privacy, Surveillance, and Profiling
...
### Integration, Community Support, and Long-Term Stability
...
**Civil Rights & Liberties**: Immigration rights protections align with broader civil rights principles including due process, equal protection, freedom from discrimination, privacy rights, and protection from state abuse. Immigration systems must respect constitutional rights regardless of citizenship status.

**Justice Reform**: Immigration detention parallels criminal justice issues including mass incarceration, private detention, inadequate representation, harsh conditions, and lack of accountability. Reforms to detention, due process, and oversight apply similar principles.

**Labor & Worker Protections**: Immigration status is a major tool of labor exploitation. Immigration reform must align with worker protection, wage standards, union rights, anti-retaliation protections, and anti-exploitation enforcement.

**Family Policy**: Family unity, anti-separation protections, child welfare safeguards, and coordinated case processing connect immigration to broader family policy priorities.

**Healthcare**: Access to healthcare regardless of immigration status, medical care in detention, mental health services, and public health protections require coordination with healthcare policy.

**Education**: Children's access to education, English language instruction, credential recognition for immigrant professionals, and protection of educational institutions from enforcement actions intersect with education policy.

**Privacy & Surveillance**: Immigration data collection, surveillance technology, biometric systems, data-sharing, and algorithmic enforcement tools raise privacy concerns that require alignment with broader privacy protections.

**Economic Policy**: Immigration levels, visa systems, labor market integration, credential recognition, and economic contributions of immigrants connect to broader economic policy including employment, wages, productivity, and growth.

**Foreign Policy & Humanitarian Response**: Asylum, refugee resettlement, trafficking protections, and humanitarian visa programs align with foreign policy priorities including humanitarian response, alliance relationships, and international obligations.
