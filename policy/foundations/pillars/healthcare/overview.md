...
- **Universal single-payer healthcare** as the long-term structural goal
- **Immediate transition-state protections** to prevent harm while universal care is implemented
- **Comprehensive coverage mandates** that include mental health, reproductive care, chronic conditions, preventive care, and disability-related services
- **Strict limits on denials and delays**, with transparency requirements, appeal processes, and penalties for repeated wrongful denials
- **AI governance** to ensure that automated systems support—but never replace—qualified human clinical judgment, and cannot be used to deny medically necessary care
- **Drug pricing and supply chain protections** to ensure reliable access to medications, including controlled substances for legitimate medical need
- **Network adequacy standards** requiring nationwide access rather than narrow regional networks
- **Mental health parity** that includes talk therapy, psychiatric care, crisis services, and emerging evidence-based treatments like psychedelic therapy
- **Telehealth expansion** to reduce geographic barriers
- **Emergency care guarantees** with no-cost access to ambulance services and follow-up care
- **Research funding** for neglected conditions that lack commercial incentives
- **Rehabilitation and treatment standards** to ban abusive practices and expand voluntary, evidence-based care

## Design Logic

The healthcare pillar is structured around **184 rules** across **20 family codes**, organized to address every layer of the healthcare system—from high-level structural design to granular operational safeguards. This comprehensive framework reflects the reality that piecemeal reform is insufficient: meaningful healthcare justice requires addressing coverage mandates, denial processes, AI systems, drug access, mental health, network adequacy, cost-sharing, employer obligations, emergency services, appeals, transparency, research priorities, and transition-state protections simultaneously.

### Family Structure

The 20 family codes group rules into logical reform areas:

- **OVR (Overview, 4 rules):** Transparency, oversight, and enforcement mechanisms
- **COV (Coverage, 30 rules):** Core coverage mandates, denial limits, pre-existing condition protections, and mandatory care floors
- **TRN (Transition, 2 rules):** Immediate protections required during the transition to universal single-payer care
- **ACC (Access, 3 rules):** Coverage eligibility for citizens and long-term residents
- **EMS (Emergency Services, 2 rules):** Free emergency care including ambulance and follow-up
- **AI (AI in Healthcare, 32 rules):** Comprehensive AI governance to ensure safety, accountability, and protection against automated denials
- **MHC (Mental Health Care, 47 rules):** Mental health parity, AI protections, crisis services, and safeguards against misuse in coercive settings
- **NET (Network, 4 rules):** Nationwide network adequacy and out-of-network protections
- **CST (Cost, 4 rules):** Cost-sharing limits, deductible protections, and health spending tools
- **EMP (Employer, 4 rules):** Employer coverage obligations, premium payment requirements, and small business supports
- **PAU (Patient Autonomy/Prior Authorization, 4 rules):** Prior authorization limits, transparency, and continuity of care protections
- **APL (Appeals, 4 rules):** Fast, independent appeal processes with penalties for wrongful denials
- **RX (Prescriptions, 11 rules):** Medication access, formulary protections, controlled substance quotas, and step-therapy limits
- **PHR (Pharmacy, 3 rules):** Generic drug quality, allergen bans, supply chain traceability
- **RSR (Research, 3 rules):** Funding for neglected conditions and public health priorities
- **REB (Rehabilitation, 7 rules):** National standards, evidence-based treatment, transparency, and bans on abusive practices
- **STD (Standards, 13 rules):** Evidence-based coverage, maximum wait times, timeline requirements, and addiction treatment standards
- **SUP (Supplements, 4 rules):** Supplement research, labeling, lab transparency, and quality standards
- **TEL (Telehealth, 2 rules):** Telemedicine without regional restrictions
- **TRL (Trials/Legislation, 1 rule):** Streamlined approvals and trials for new treatments

### AI and Mental Health: A Deep Dive

Two of the largest family groups—**AI (32 rules)** and **MHC (47 rules)**—reflect the critical importance of protecting patients from emerging risks posed by automated systems and ensuring mental health parity.
...
### Universal Coverage and Transition Protections

The long-term goal is **single-payer universal healthcare** with a single plan for all, eliminating tiered coverage and insurance fragmentation (HLT-COV-001 through HLT-COV-003). Until this is achieved, **transition-state protections** require aggressive regulation of existing coverage systems to prevent denial, delay, and extractive practices (HLT-TRN-001, HLT-TRN-002). Transition reforms must improve care immediately without weakening or delaying the universal care goal.

Coverage is extended to citizens and long-term residents, with residency requirements for elective care and exceptions for severe conditions (HLT-ACC-001 through HLT-ACC-003). This ensures universal access while managing system capacity during implementation.

### Coverage Mandates and Denial Protections

Coverage systems must include a **broad mandatory floor of medically necessary care** including preventive, acute, chronic, reproductive, mental, and disability-related care (HLT-COV-022). Coverage rules must be written in clear language and interpreted in favor of access where ambiguity exists (HLT-COV-024). Coverage may not be denied, restricted, or delayed except through fair, transparent, timely, and medically grounded review processes (HLT-COV-018).

Denial rates, delay patterns, and reversal rates must be publicly reported (HLT-COV-020), and repeated unjustified denial must trigger penalties, corrective action, and possible loss of plan participation authority (HLT-COV-021). Coverage exclusions cannot be written so broadly or vaguely that they undermine practical availability of necessary care (HLT-COV-023).

Protections against denial or exclusion based on **pre-existing conditions** must be permanent, explicit, and difficult to weaken or roll back (HLT-COV-026). Insurers cannot use pre-existing-condition logic indirectly through pricing, network design, utilization controls, or exclusionary administration (HLT-COV-027).

### Insurance Reform: Prior Authorization, Timelines, and Appeals

**Prior authorization** requirements must be strictly limited to categories with clear evidence of necessity and cannot be used indiscriminately across routine care (HLT-PAU-001). Prior authorization systems must be transparent, clinically justified, and easy to navigate (HLT-PAU-002). Repeated approval of the same type of medically necessary treatment should reduce or eliminate future prior authorization burdens (HLT-PAU-003).

Coverage decisions and prior authorization determinations must meet **strict maximum response timelines** (HLT-STD-005), with accelerated timelines for urgent and emergency-related decisions (HLT-STD-006). If a decision is not made within required timelines, the requested care should be presumptively approved (HLT-STD-007). Administrative delay cannot be used as a strategy to avoid payment or discourage care (HLT-STD-008).

**Appeals** must be fast, meaningful, and independent (HLT-APL-001). Appeals involving urgent medically necessary treatment must be resolved on timelines that prevent avoidable deterioration, injury, or death (HLT-APL-002). Independent external review must be available and cannot be controlled by the same entity that issued the denial (HLT-APL-003). Successful appeals should trigger review of underlying denial patterns and potential penalties (HLT-APL-004).

### Drug Pricing, Access, and Supply Chain

Drug coverage systems must include broad access to medically necessary prescriptions and cannot use formularies as hidden denial systems (HLT-RX-001). Patients must have fast and meaningful exception pathways when formulary restrictions conflict with individualized medical need (HLT-RX-002). Coverage systems cannot force repeated medication failure or step-therapy loops where doing so is medically harmful (HLT-RX-003).

**Production quotas and regulatory limits on controlled medications** must be set at levels that ensure reliable patient access and may not create artificial shortages (HLT-RX-005). Controlled substance quotas must be based on real-world medical demand, prescribing data, and public health needs rather than static limits (HLT-RX-007). When shortages occur, regulators must act rapidly to adjust quotas, supply chains, and distribution to restore access (HLT-RX-008).

Patients receiving ongoing treatment with controlled medications cannot have care disrupted due to supply shortages, quota limits, or administrative barriers beyond their control (HLT-RX-011). Expansion of access must be paired with evidence-based prescribing guidelines and safeguards against diversion without restricting legitimate care (HLT-RX-010).

Generic drug quality standards, bans on unnecessary allergens, and supply chain traceability are required to ensure medication safety and reliability (HLT-PHR-001 through HLT-PHR-003).

### Mental Health Parity and AI Safeguards

Mental healthcare must be included (HLT-MHC-001) with full parity: coverage systems cannot impose narrower networks, harsher utilization controls, or lower practical access for mental healthcare than for physical healthcare (HLT-COV-030). Coverage must include talk therapy, psychiatric care, crisis services, and medically appropriate longer-term treatment (HLT-COV-029).

Where evidence and law support it, coverage should include emerging therapies such as psychedelic-assisted treatment under appropriate medical supervision (HLT-COV-031).

AI systems in mental health are regulated as high-risk (HLT-MHC-002) and may not replace licensed clinicians in diagnosis, crisis assessment, involuntary treatment decisions, or other high-risk determinations (HLT-MHC-003, HLT-MHC-004). A clearly identifiable licensed human professional must remain accountable for all high-risk mental health decisions involving AI systems (HLT-MHC-005).

AI systems cannot deceptively present themselves as human therapists or cultivate emotional dependency (HLT-MHC-009, HLT-MHC-010). Special protections are required for minors (HLT-MHC-012), including bans on conversational AI for children under 8 years old (HLT-MHC-038) and graduated age-based restrictions for older minors (HLT-MHC-039).

Mental health AI data is treated as highly sensitive and cannot be sold, shared for advertising, or used by employers, insurers, schools, or landlords to deny opportunity (HLT-MHC-017, HLT-MHC-018). AI systems cannot be used coercively in schools, workplaces, prisons, or public benefits systems without strict legal safeguards (HLT-MHC-024, HLT-MHC-026, HLT-MHC-027, HLT-MHC-028).

People retain the right to access human mental healthcare and may not be forced into AI-only services (HLT-MHC-023, HLT-MHC-030).

### Network Adequacy and Telehealth

Health plans must maintain **adequate networks** for all covered services including specialty care, mental healthcare, emergency care, and chronic-condition management (HLT-NET-001). Health plan networks must function **nationally** rather than trapping people in narrow regional structures (HLT-NET-002). If adequate in-network care is not available within reasonable time and distance standards, out-of-network care must be covered at in-network cost to the patient (HLT-NET-003).

**Telemedicine** must be available without regional restriction (HLT-TEL-001) and should serve as an access equalizer (HLT-TEL-002), reducing geographic barriers for rural and underserved communities.
...
Deductibles, copays, and out-of-pocket cost structures must not make covered care practically inaccessible (HLT-CST-001). Healthcare cost-sharing rules must be regulated to protect patients from financial shock, delay of care, and medically harmful underuse (HLT-CST-002). Cost-sharing design cannot be used to discourage care for chronic conditions, disability-related needs, or preventive treatment (HLT-CST-004).

Employers may not satisfy healthcare obligations by offering only high-deductible plans that shift unreasonable cost burden onto workers (HLT-EMP-001). Employers should be required to pay the full premium cost of employee health coverage, subject to clearly defined exceptions and small-business supports (HLT-EMP-002, HLT-EMP-003).

### Reproductive Healthcare

Coverage systems must include comprehensive reproductive care—abortion, contraception, gender-affirming care, and protection against forced or non-consensual surgeries for intersex babies. Reproductive healthcare is explicitly included in the mandatory floor of medically necessary care (HLT-COV-022) and protected from political interference (HLT-STD-002). Coverage decisions must be evidence-based and may not be restricted by partisan ideology or state-level bans.

### Research Priorities and Neglected Conditions

Public healthcare and research policy must **increase funding for neglected conditions, medications, and treatment gaps** that lack commercial incentives but have significant public-health impact (HLT-RSR-001). Research priorities should include stigmatized or less commercially attractive conditions, including sexually transmitted infections, chronic conditions, and under-studied medication needs (HLT-RSR-002). Healthcare governance must not allow commercial buzz or market hype to determine research priority at the expense of real public-health need (HLT-RSR-003).

AI may be used to accelerate medical research and drug development provided it meets safety, transparency, and ethical standards (HLT-AI-020). Funding should specifically support research into under-studied conditions, treatments, and medications including diseases that are historically neglected or lack commercial incentives (HLT-AI-021, HLT-AI-022).

### Rehabilitation and Substance Use Treatment

National rehabilitation standards must require evidence-based treatment (HLT-REB-002) and ban abusive rehab practices (HLT-REB-003). Rehabilitation systems must be transparent (HLT-REB-004), accessible (HLT-REB-005), and subject to oversight and audits (HLT-REB-006). Voluntary treatment options should be expanded (HLT-REB-007).

Addiction must be treated as a medical condition (HLT-STD-012), with harm reduction strategies integrated into care (HLT-STD-013). This reflects evidence-based public health policy rather than punitive or moralistic approaches.

### Transparency and Oversight

Coverage entities must publicly report **denial rates, appeal outcomes, prior authorization burden, network adequacy failures, and major access complaints** in standardized formats (HLT-OVR-001). Healthcare oversight bodies must have authority to investigate systemic denial, delay, undercoverage, or misleading plan design and impose meaningful penalties (HLT-OVR-002).

Coverage entities cannot hide harmful practices behind proprietary standards, trade secrecy, or intentionally complex plan language (HLT-OVR-003). Regulators must be empowered to require corrective action, restitution, or suspension of plan participation where repeated patient harm occurs (HLT-OVR-004).

Evidence-based coverage decisions require full transparency (HLT-STD-009), with published dissenting opinions (HLT-STD-010) and independent audit systems (HLT-STD-011). This ensures that coverage decisions are scientifically grounded and free from commercial or political distortion.

## Research & Context

### The Case for Universal Single-Payer Healthcare

The United States is the only wealthy nation without universal healthcare, resulting in worse health outcomes, higher costs, and profound inequities. The current system is structured around insurance companies whose business model depends on denying care, minimizing payouts, and extracting maximum premiums while providing minimum coverage. This creates perverse incentives where profitability is inversely correlated with patient health.
...
Patients seeking mental health treatment face months-long wait times, out-of-pocket costs for out-of-network providers (because in-network providers are unavailable), and arbitrary session limits. Insurers deny claims for "lack of medical necessity" using opaque criteria that override licensed clinical judgment. Crisis services are under-funded and under-available, leading to psychiatric emergencies being handled by police and emergency rooms rather than appropriate mental health facilities.
...
- **Pillar 1 (Rights and Protections):** Healthcare as a right, reproductive autonomy, bodily autonomy, protection from coercion
- **Pillar 7 (AI Regulation):** AI safety, accountability, transparency, and human oversight requirements applicable across domains including healthcare
- **Pillar 10 (Labor Rights):** Employer healthcare obligations, worker protections, paid medical leave
- **Pillar 3 (Taxation and Economic Justice):** Progressive taxation to fund universal healthcare, wealth redistribution
