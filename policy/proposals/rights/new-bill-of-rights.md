...
Each amendment is structured as follows:

- **The right** — a short, plainly stated name
- **What it means** — one sentence
- **Sub-rights** — the major guarantees that together constitute the amendment
- **Floor** — the minimum government may not violate, erode, or fall beneath; a rule fails if it crosses the floor
- **Duty** — the positive obligation government must actively secure, build, preserve, and advance; a rule is incomplete if it does not satisfy the duty
...
*This amendment is a constitutional statement of recognition and obligation. The full architecture of these rights is set out in the [Declaration of Indigenous Rights](indigenous-rights.md), which carries equal force as a foundational document of this project.*
...
The original Bill of Rights has ten amendments. This project's New Bill of Rights has exactly ten. That is not a coincidence. It is an assertion: this is the next chapter of that document. The unfinished work of 1791. The unbuilt promises of 1944. The rights we have not yet had the courage to guarantee.

Ten amendments for the century we live in.

---

## Related Documents

- [New Bill of Workers' Rights](workers-rights.md) — rights in the economic sphere, for every worker; co-equal, fully supported
- [Declaration of Indigenous Rights](indigenous-rights.md) — rights that predate this government, finally recognized; co-equal, fully supported
- [PolicyOS Platform Values](../../policyos/policyos_platform_values_v1.md) — the moral and political foundation for the floor + duty model used throughout
