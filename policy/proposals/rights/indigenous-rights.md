...
- **Federally recognized tribal nations** — the 574 federally recognized tribes, each a sovereign nation
- **Non-recognized nations** — tribes denied federal recognition through processes that were themselves often discriminatory
- **Native Hawaiian people** — whose sovereignty over their lands was ended by an illegal U.S.-backed coup in 1893
- **Pacific Islander peoples** — including Chamorros (Guam), American Samoans, the peoples of the Commonwealth of the Northern Mariana Islands, and the COFA nations (Republic of the Marshall Islands, Federated States of Micronesia, Republic of Palau)
...
Each right is structured as follows:

- **The right** — a short, plainly stated name
- **What it means** — one sentence
- **Floor** — the minimum the government may not violate, erode, or fall beneath; a rule fails if it crosses the floor
- **Duty** — the positive obligation government must actively fulfill, build, preserve, and advance; a rule is incomplete if it does not satisfy the duty

*The floor and duty model is drawn from [PolicyOS Platform Values](../../policyos/policyos_platform_values_v1.md). These are not aspirations — they are requirements.*
...
- **Native Hawaiians** are an Indigenous people whose sovereignty was ended by an illegal U.S. coup. The legal and political path to restoration is complex, but the obligation is clear.
- **American Samoans** are the only people born on U.S. soil who are not automatically citizens — a civil rights issue hiding in plain sight.
- **Chamorros of Guam** cannot vote for the president of the country that deploys them into military service and occupies their land.
- **Marshall Islanders** live with the legacy of U.S. nuclear testing on their atolls. Bikini Atoll remains uninhabitable. The people were told it was safe to return in 1968. It was not.
- **COFA nations** have complex relationships with the U.S. that include rights to live and work here, but have historically been excluded from federal benefits like Medicaid.
...
- [A New Bill of Rights](new-bill-of-rights.md) — Amendment VI (Right to Indigenous Sovereignty) is the constitutional anchor that points here
- [New Bill of Workers' Rights](workers-rights.md) — third co-equal foundational document
- [PolicyOS Platform Values](../../policyos/policyos_platform_values_v1.md) — the floor + duty model

---

*Draft for review — Freedom and Dignity Project, April 2026. All feedback welcome.*
