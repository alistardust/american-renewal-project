...
- **Floor** — the minimum that no employer or government may violate; a rule fails if it crosses the floor
...
These ten rights are additional — the obligations specific to the employment relationship, where the concentration of economic power creates its own forms of coercion that the general Bill of Rights does not fully address.

They stack. A worker wrongfully terminated for organizing has protections under both Amendment III of the New Bill and Right 8 of this document. A pregnant worker facing discrimination has protections under both Amendment VIII and Rights 7 and 10 here. The documents reinforce each other.

---

## Related Documents

- [A New Bill of Rights](new-bill-of-rights.md) — the foundation; applies to all workers as persons
- [Declaration of Indigenous Rights](indigenous-rights.md) — third co-equal foundational document
