...
const siteData = {
  ...
  pillars: [
    ...
    { id: 'foreign_policy',               title: 'Foreign Policy',                foundation: 'equal-justice',      summary: 'American foreign policy must be anchored in human rights, diplomacy, and accountability — not arms deals and endless war.', points: ['Human rights conditionality on arms sales', 'Diplomatic primacy over military intervention', 'Responsibility to repair what we have broken'] },
